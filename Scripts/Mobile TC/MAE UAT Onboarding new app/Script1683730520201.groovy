...
Mobile.startApplication('/Users/APK/MAEsecurityPINbyPass.apk', false)
...
not_run: Mobile.tap(findTestObject('SPY MAE without firebase/spy3/userid EditText'), 0, FailureHandling.CONTINUE_ON_FAILURE)

not_run: Mobile.setText(findTestObject('SPY MAE without firebase/spy3/userid EditText'), 'samuat05', 0)
...
not_run: if (Mobile.verifyElementText(findTestObject('SPY MAE without firebase/Proceed'), 'Proceed', FailureHandling.OPTIONAL) == 
true) {
